...
if(!empty($_POST)){
  ...
  if(empty($err_msg)){
    ...
    try{
      ...
      $dbh = dbConnect();
      //SQL文作成
      $sql = 'UPDATE users SET username = :username, tel = :tel, zip = :zip,
      addr = :addr, age = :age, email = :email, pic = :pic WHERE id = :id';
      $data = array(':username' => $username, ':tel' => $tel, ':zip' => $zip,
    ':addr' => $addr, ':age' => $age, ':email' => $email, ':pic' => $pic,':id' => $dbFormData['id']);
    //クエリ実行
        ...
        <div class="form-container">
          <form action="" method="post" class="form" enctype="multipart/form-data">
            ...
            <label class="area-drop" style="height:370px;line-height:370px;">
              ...
              <img src="<?php echo getFormData('pic');?>" alt="" class="prev-img" style="<?php if(empty(getFormData('pic'))) echo 'diplay:none';?>">
                ドラッグ＆ドロップ
            </label>
            <div class="area-msg">
              <?php
