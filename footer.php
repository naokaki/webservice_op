...
?>
<footer id="footer">
  <a href="registproduct.php">Copyright</a> <a href="http://webukatu.com/">PLAY BADMINTON</a>. All Rights Reserved.
</footer>

<script src="js/vendor/jquery-2.2.2.min.js"></script>
<script src="https://kit.fontawesome.com/a5015b7e73.js"></script>
<script>
// //ヘッダーの高さ分だけコンテンツを下げる
// $(function() {
//     var height=$("#header").height();
//     $("body").css("margin-top", height + 40);//10pxだけ余裕をもたせる
// });
  $(function(){
